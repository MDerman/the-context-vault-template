...
| Default location for new attachments | `master/_obsidian/attachments/_inbox` as the temporary paste inbox |
...
{
  "promptDelete": false,
  "attachmentFolderPath": "master/_obsidian/attachments/_inbox",
