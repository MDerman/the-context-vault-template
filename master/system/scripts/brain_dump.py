...
DEFAULT_CONFIG = {
    ...
    "output_path": "master/system/inbox/BRAIN_DUMP.md",
    "attachments_path": "master/system/inbox/BRAIN_DUMP_ATTACHMENTS",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--config", default=None, help="Vault-relative config path. Defaults to master/system/config.json.")
