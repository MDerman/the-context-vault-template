...
COMMANDS = {
    ...
    "triage": ROOT / "master/agents/skills/brain-dump-organizer/scripts/triage.py",
...
Examples:
  ...
  vault refresh --all
  vault inventory
  vault task create 03-business "Follow up with partner" --project "Partnerships" --epic "Growth"
  vault project create 03-business "New Project" --epic "Growth"
