...
UCT = ROOT / "02-personal-brand" / "Learning" / "UCT - Student Dashboard"
COURSES = UCT / "Courses"
BRAINFOOD = UCT / "Brainfood"
BRAINFOOD_NO_COURSE = UCT / "Brainfood No Courses"
BASES = ROOT / "02-personal-brand" / "_obsidian" / "bases"
...
def rewrite_links(text: str, file_path: Path, path_map: dict[Path, Path], stats: Counter[str]) -> str:
    ...
    def replace_wiki(match: re.Match[str]) -> str:
        ...
        candidates.append((ROOT / "02-personal-brand" / target_path).resolve())
...
FROM "02-personal-brand/Learning/UCT - Student Dashboard/Brainfood"
...
def write_bases(dry_run: bool) -> Counter[str]:
    ...
    courses_content = """# 02-personal-brand UCT Courses
...
views:
  - type: table
    ...
    order:
      ...
      - credits
"""
    brainfood_content = """# 02-personal-brand UCT Brainfood
