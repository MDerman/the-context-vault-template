...
MANAGED_MARKER = "managed-by: master/system/scripts/generate_epic_kanban_views.py"
OLD_MANAGED_MARKER = "managed-by: master/scripts/generate_epic_kanban_views.py"
