...
MARKER = "managed-by: master/system/scripts/context.py"
...
LEGACY_AGENT_SYSTEM_DIR = Path("master/system/context/system")
DASHBOARD_PATH = Path("master/Dashboard.md")
SYSTEM_NOTES = {
    "start_here": "master/00-StartHere.md",
    "context": "master/01-Context.md",
    "identity": "master/02-Identity.md",
    "momentum": "master/03-Momentum.md",
}
...
def dashboard_markdown(
    ...
    standing_lines = [
        obsidian_link("master/system/context/00-StartHere.md", "00-StartHere"),
        obsidian_link("master/system/context/01-Context.md", "01-Context"),
        obsidian_link("master/system/context/02-Identity.md", "02-Identity"),
        obsidian_link("master/system/context/03-Momentum.md", "03-Momentum"),
    ]
    periodic_lines = [
    ...
    base_lines = [
        obsidian_link("master/_obsidian/bases/tasks-kanban-v1.base", "Tasks Kanban"),
        obsidian_link("master/_obsidian/bases/content-kanban.base", "Content Kanban"),
    ]
...
def main(argv: list[str] | None = None) -> None:
    ...
    state_path = root / "master/system/context/context.json"
    ...
    state = {
        ...
        "content_views": {
            "content_calendar": "master/_obsidian/bases/content-calendar.base",
            "content_kanban": "master/_obsidian/bases/content-kanban.base",
            "entity_views": {
                entity: {
