...
```bash
vault task create 03-business "Task title" --project "Existing Project" --epic "Existing Epic" --status backlog --priority normal
```
...
```bash
vault project create 03-business "New Project" --epic "Existing Epic" --status backlog
vault epic create 03-business "New Epic" --status in-progress
