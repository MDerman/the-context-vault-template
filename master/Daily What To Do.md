...
[[Dashboard]]
[[master/system/context/03-Momentum|03-Momentum]]
...
better apple notes organizer command that just groups text and attachments inside hte apple note itself. skill.md

/propose command
(keep a log of weekly schedules proposed/calendar blocks)
then in end of daily note, voice/type what actually went down.
