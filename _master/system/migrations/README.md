...
```bash
python3 _master/system/migrations/<script>.py --root /path/to/vault --report /path/to/report.json --dry-run
python3 _master/system/migrations/<script>.py --root /path/to/vault --report /path/to/report.json --apply
```
