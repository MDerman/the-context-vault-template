...
Repository path resolves through `_system/local/skills/infra-code-folder-and-computer-topology/private/repositories.json`. Override config for testing with `UTM_LINKS_CONFIG` or `--config`.
