...
| Default location for new attachments | `_system/_obsidian/attachments/_inbox` as the temporary paste inbox |
...
{
  "promptDelete": false,
  "attachmentFolderPath": "_system/_obsidian/attachments/_inbox",
