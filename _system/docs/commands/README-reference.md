...
- `worker_bootstrap.py`: explicitly installs versioned hooks and creates or repairs sparse worker checkouts without background Git synchronization. Use `vault worker-sync`.
