...
Read [[_system/agents/auto-skills/_infrastructure/code-folder-and-computer-topology/README-primary-worker-vault-sync|Primary and Worker Vault Coordination]] before acting. It defines generic fleet roles, registry routing, checkout rules, and safe Git behavior.
