...
from vault_layout import INBOX_DIR, SYSTEM_OBSIDIAN_DIR, VAULT_CONFIG_PATH

INBOX_PATH = INBOX_DIR / "BRAIN_DUMP.md"
ATTACHMENTS_DIR = INBOX_DIR / "BRAIN_DUMP_ATTACHMENTS"
BACKUPS_DIR = INBOX_DIR / "BRAIN_DUMP_BACKUPS"
PROPOSALS_DIR = INBOX_DIR / "BRAIN_DUMP_PROPOSALS"
BASE_PATH = SYSTEM_OBSIDIAN_DIR / "bases/BRAIN_DUMP_TRIAGE.base"
...
def resolve_root(root_arg: str | None = None) -> Path:
    ...
    for candidate in [current, *current.parents]:
        if (candidate / "AGENTS.md").exists() and (candidate / "_system").is_dir():
            return candidate
